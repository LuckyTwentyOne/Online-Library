...
@WebServlet(urlPatterns = { "/reader/main/sortByName", "/main/sortByName" })
public class SortBooksByNameServlet extends AbstractServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		List<Book> booksList = getReaderService().findAllBooksSortedByName(req, limit, (page - 1) * limit);
