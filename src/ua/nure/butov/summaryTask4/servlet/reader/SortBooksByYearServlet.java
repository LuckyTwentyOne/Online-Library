...
@WebServlet(urlPatterns = { "/reader/main/sortByYear", "/main/sortByYear" })
public class SortBooksByYearServlet extends AbstractServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		List<Book> booksList = getReaderService().findAllBooksSortedByYear(req, limit, (page - 1) * limit);
