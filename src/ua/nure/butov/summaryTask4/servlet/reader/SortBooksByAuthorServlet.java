...
@WebServlet(urlPatterns = { "/reader/main/sortByAuthor", "/main/sortByAuthor" })
public class SortBooksByAuthorServlet extends AbstractServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		List<Book> booksList = getReaderService().findAllBooksSortedByAuthor(req, limit, (page - 1) * limit);
