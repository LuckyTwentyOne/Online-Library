...
<div class="row" style="min-height: 600px">
	...
	<div class="row">
		<div class="table">
			<div class="row">
				<c:if test="${successfullyUpdatedAccount!=null }">
					<div class="alert alert-success text-center" role="alert">
						<mytags:message key="adminHomeAccounts.account" />
						&nbsp;${successfullyUpdatedAccount }&nbsp;
						<mytags:message key="adminHomeAccounts.successEdited" />
					</div>
				</c:if>
				<c:if test="${addedAccount!=null }">
					<div class="alert alert-success text-center" role="alert">
						<mytags:message key="adminHomeAccounts.account" />
						&nbsp;${addedAccount }&nbsp;
						<mytags:message key="adminHomeAccounts.successCreated" />
					</div>
				</c:if>
				<c:if test="${deletedAccount!=null }">
					<div class="alert alert-success text-center" role="alert">
						<mytags:message key="adminHomeAccounts.account" />
						&nbsp;${deletedAccount }&nbsp;
						<mytags:message key="adminHomeAccounts.successDeleted" />
					</div>
				</c:if>
				<div class="col-lg-1">
				...
				<div class="col-lg-7 text-center table-header">
					<mytags:message key="adminHomeAccounts.list" />
				</div>

				<div class="col-lg-4">
					<form action="/SummaryTask4/admin/home" method="post">
			...
			<nav aria-label="Search results pages">
				<ul class="pagination">
					<c:if test="${pageNumber != 1}">
						<li><a
							href="/SummaryTask4/admin/home?page=${pageNumber - 1 }"
					...
					<c:forEach begin="1" end="${neededPages}" var="i">
						<c:choose>
							...
							<c:otherwise>
								<li><a href="/SummaryTask4/admin/home?page=${i}">${i}</a></li>
							</c:otherwise>
						</c:choose>
					</c:forEach>
